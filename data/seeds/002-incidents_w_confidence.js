exports.seed = function (knex) {
  ...
  return knex('incidents_w_confidence')
    .del()
    .then(function () {
      // Inserts seed entries
      return knex('incidents_w_confidence').insert([
        {
          id: 1,
          ...
          links: ['https://www.kcci.com/article/developing-protesters-face-off-with-police-in-downtown-des-moines/32717301'],
          city: "Des Moines",
          state: "Iowa",
          lat: 41.5865739,
          lon: -93.6164429,
          title: 'Police repeatedly shoot tear gas into crowd, even after crowd has dispersed',
          tags:
            ['gas', 'mace', 'protester', 'tear gas', 'tear gas canister', 'throw'],
